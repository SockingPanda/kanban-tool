...
import staticValidator from "virtual:kanban-contract-validator/api-list-events-query";
...
export type ApiListEventsQueryContract = ContractValue<typeof ApiListEventsQuerySchema>;
