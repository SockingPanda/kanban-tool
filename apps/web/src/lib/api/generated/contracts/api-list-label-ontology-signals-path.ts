...
import staticValidator from "virtual:kanban-contract-validator/api-list-label-ontology-signals-path";
...
export type ApiListLabelOntologySignalsPathContract = ContractValue<typeof ApiListLabelOntologySignalsPathSchema>;
