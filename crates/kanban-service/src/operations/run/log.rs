...
pub(crate) fn application_run(run: crate::domain::TaskRunRecord) -> Result<crate::RunRecord> {
    let status = match run.status.as_str() {
        "running" => crate::RunStatus::Running,
        "succeeded" => crate::RunStatus::Succeeded,
        "failed" => crate::RunStatus::Failed,
        "canceled" => crate::RunStatus::Canceled,
        "expired" => crate::RunStatus::Expired,
        other => {
