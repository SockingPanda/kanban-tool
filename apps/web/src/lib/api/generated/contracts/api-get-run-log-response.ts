...
import staticValidator from "virtual:kanban-contract-validator/api-get-run-log-response";
...
export type ApiGetRunLogResponseContract = ContractValue<typeof ApiGetRunLogResponseSchema>;
