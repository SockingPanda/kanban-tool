...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-import-v30-request";
...
export type ApiMaintenanceImportV30RequestContract = ContractValue<typeof ApiMaintenanceImportV30RequestSchema>;
