...
import staticValidator from "virtual:kanban-contract-validator/runtime-web-config-output";
...
export type RuntimeWebConfigOutputContract = ContractValue<typeof RuntimeWebConfigOutputSchema>;
