...
import staticValidator from "virtual:kanban-contract-validator/api-list-attachments-path";
...
export type ApiListAttachmentsPathContract = ContractValue<typeof ApiListAttachmentsPathSchema>;
