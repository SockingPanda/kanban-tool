...
import staticValidator from "virtual:kanban-contract-validator/api-suggest-task-labels-headers";
...
export type ApiSuggestTaskLabelsHeadersContract = ContractValue<typeof ApiSuggestTaskLabelsHeadersSchema>;
