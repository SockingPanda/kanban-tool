...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-backup-response";
...
export type ApiMaintenanceBackupResponseContract = ContractValue<typeof ApiMaintenanceBackupResponseSchema>;
