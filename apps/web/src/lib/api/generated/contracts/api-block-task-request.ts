...
import staticValidator from "virtual:kanban-contract-validator/api-block-task-request";
...
export type ApiBlockTaskRequestContract = ContractValue<typeof ApiBlockTaskRequestSchema>;
