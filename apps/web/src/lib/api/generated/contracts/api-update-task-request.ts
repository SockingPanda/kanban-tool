...
import staticValidator from "virtual:kanban-contract-validator/api-update-task-request";
...
export type ApiUpdateTaskRequestContract = ContractValue<typeof ApiUpdateTaskRequestSchema>;
