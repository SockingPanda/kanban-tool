...
import staticValidator from "virtual:kanban-contract-validator/api-claim-task-request";
...
export type ApiClaimTaskRequestContract = ContractValue<typeof ApiClaimTaskRequestSchema>;
