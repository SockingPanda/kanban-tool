...
import staticValidator from "virtual:kanban-contract-validator/api-list-tasks-query";
...
export type ApiListTasksQueryContract = ContractValue<typeof ApiListTasksQuerySchema>;
