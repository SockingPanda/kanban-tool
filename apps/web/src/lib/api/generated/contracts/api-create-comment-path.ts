...
import staticValidator from "virtual:kanban-contract-validator/api-create-comment-path";
...
export type ApiCreateCommentPathContract = ContractValue<typeof ApiCreateCommentPathSchema>;
