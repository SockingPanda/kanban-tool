...
import staticValidator from "virtual:kanban-contract-validator/api-list-task-labels-path";
...
export type ApiListTaskLabelsPathContract = ContractValue<typeof ApiListTaskLabelsPathSchema>;
