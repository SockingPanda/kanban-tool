...
import staticValidator from "virtual:kanban-contract-validator/api-list-boards-headers";
...
export type ApiListBoardsHeadersContract = ContractValue<typeof ApiListBoardsHeadersSchema>;
