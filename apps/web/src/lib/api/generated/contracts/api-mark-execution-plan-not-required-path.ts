...
import staticValidator from "virtual:kanban-contract-validator/api-mark-execution-plan-not-required-path";
...
export type ApiMarkExecutionPlanNotRequiredPathContract = ContractValue<typeof ApiMarkExecutionPlanNotRequiredPathSchema>;
