...
import { validateBoardViewModel } from "../../domain/tasks/board"
import { englishBoardMessages } from "../../domain/tasks/board"
import type { BoardTaskViewModel, BoardViewModel } from "../../domain/tasks/board"
...
describe("BoardView", () => {
  ...
  test("键盘可到达列 section、heading 和横向滚动 region", () => {
    ...
    expect(markup).toMatch(/<div class="[^"]*boardContent[^"]*" id="paper-board-columns"/)
