...
import staticValidator from "virtual:kanban-contract-validator/api-get-run-log-path";
...
export type ApiGetRunLogPathContract = ContractValue<typeof ApiGetRunLogPathSchema>;
