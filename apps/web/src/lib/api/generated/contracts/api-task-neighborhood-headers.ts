...
import staticValidator from "virtual:kanban-contract-validator/api-task-neighborhood-headers";
...
export type ApiTaskNeighborhoodHeadersContract = ContractValue<typeof ApiTaskNeighborhoodHeadersSchema>;
