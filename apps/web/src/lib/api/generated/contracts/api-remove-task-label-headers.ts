...
import staticValidator from "virtual:kanban-contract-validator/api-remove-task-label-headers";
...
export type ApiRemoveTaskLabelHeadersContract = ContractValue<typeof ApiRemoveTaskLabelHeadersSchema>;
