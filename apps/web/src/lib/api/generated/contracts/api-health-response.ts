...
import staticValidator from "virtual:kanban-contract-validator/api-health-response";
...
export type ApiHealthResponseContract = ContractValue<typeof ApiHealthResponseSchema>;
