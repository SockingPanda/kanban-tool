...
import staticValidator from "virtual:kanban-contract-validator/api-list-steps-path";
...
export type ApiListStepsPathContract = ContractValue<typeof ApiListStepsPathSchema>;
