...
import staticValidator from "virtual:kanban-contract-validator/api-list-tasks-by-status-headers";
...
export type ApiListTasksByStatusHeadersContract = ContractValue<typeof ApiListTasksByStatusHeadersSchema>;
