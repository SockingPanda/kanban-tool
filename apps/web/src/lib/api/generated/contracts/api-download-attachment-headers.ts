...
import staticValidator from "virtual:kanban-contract-validator/api-download-attachment-headers";
...
export type ApiDownloadAttachmentHeadersContract = ContractValue<typeof ApiDownloadAttachmentHeadersSchema>;
