...
import staticValidator from "virtual:kanban-contract-validator/api-claim-task-headers";
...
export type ApiClaimTaskHeadersContract = ContractValue<typeof ApiClaimTaskHeadersSchema>;
