...
import staticValidator from "virtual:kanban-contract-validator/api-create-comment-request";
...
export type ApiCreateCommentRequestContract = ContractValue<typeof ApiCreateCommentRequestSchema>;
