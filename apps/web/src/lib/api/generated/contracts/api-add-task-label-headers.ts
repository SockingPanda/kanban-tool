...
import staticValidator from "virtual:kanban-contract-validator/api-add-task-label-headers";
...
export type ApiAddTaskLabelHeadersContract = ContractValue<typeof ApiAddTaskLabelHeadersSchema>;
