...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-export-response";
...
export type ApiMaintenanceExportResponseContract = ContractValue<typeof ApiMaintenanceExportResponseSchema>;
