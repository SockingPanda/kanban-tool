...
import staticValidator from "virtual:kanban-contract-validator/api-create-step-request";
...
export type ApiCreateStepRequestContract = ContractValue<typeof ApiCreateStepRequestSchema>;
