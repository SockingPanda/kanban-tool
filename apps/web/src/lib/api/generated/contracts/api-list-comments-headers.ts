...
import staticValidator from "virtual:kanban-contract-validator/api-list-comments-headers";
...
export type ApiListCommentsHeadersContract = ContractValue<typeof ApiListCommentsHeadersSchema>;
