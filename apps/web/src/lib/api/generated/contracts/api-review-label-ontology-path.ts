...
import staticValidator from "virtual:kanban-contract-validator/api-review-label-ontology-path";
...
export type ApiReviewLabelOntologyPathContract = ContractValue<typeof ApiReviewLabelOntologyPathSchema>;
