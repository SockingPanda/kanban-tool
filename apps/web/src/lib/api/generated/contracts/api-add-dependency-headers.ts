...
import staticValidator from "virtual:kanban-contract-validator/api-add-dependency-headers";
...
export type ApiAddDependencyHeadersContract = ContractValue<typeof ApiAddDependencyHeadersSchema>;
