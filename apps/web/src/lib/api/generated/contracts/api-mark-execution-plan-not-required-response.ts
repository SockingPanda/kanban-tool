...
import staticValidator from "virtual:kanban-contract-validator/api-mark-execution-plan-not-required-response";
...
export type ApiMarkExecutionPlanNotRequiredResponseContract = ContractValue<typeof ApiMarkExecutionPlanNotRequiredResponseSchema>;
