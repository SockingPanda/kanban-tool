...
import staticValidator from "virtual:kanban-contract-validator/api-list-attachments-response";
...
export type ApiListAttachmentsResponseContract = ContractValue<typeof ApiListAttachmentsResponseSchema>;
