...
import staticValidator from "virtual:kanban-contract-validator/api-create-attachment-path";
...
export type ApiCreateAttachmentPathContract = ContractValue<typeof ApiCreateAttachmentPathSchema>;
