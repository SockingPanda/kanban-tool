...
fn application_projection_state(
    state: kanban_store_turso::ProjectionStateRecord,
...
fn application_graph_status(
    status: kanban_store_turso::GraphStatusRecord,
...
fn application_task_neighborhood(
    graph: kanban_store_turso::TaskNeighborhoodRecord,
) -> Result<TaskNeighborhoodRecord> {
...
fn application_board_task_map(
    graph: kanban_store_turso::BoardTaskMapRecord,
) -> Result<BoardTaskMapRecord> {
...
fn application_graph_node(
    node: kanban_store_turso::TaskGraphNodeRecord,
...
fn application_graph_edge(
    edge: kanban_store_turso::TaskGraphEdgeRecord,
...
fn application_graph_meta(
    meta: kanban_store_turso::TaskGraphMetaRecord,
