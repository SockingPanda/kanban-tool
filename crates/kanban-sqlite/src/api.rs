...
pub mod provider {
    pub use crate::service::{
        ...
        ManualLabelProposalProvider, build_context_pack_with_vector_store,
        label_atom_index_status_with, propose_task_label_with,
        ...
        suggest_task_labels_with, sync_vector_store_with,
...
pub use crate::service::{
    ...
    MaintenanceResult, OutboxListOptions, PRIORITY_ERROR, QueueStats, RunLogPathStatus,
    SearchIndexState, SelectedLabelSuggestion, SignalCommentInput, SignalLifecycle,
    SignalListOptions, SignalObservationRecord, SignalRecord, SignalRecordInput,
    SignalRecordResult, SignalReviewInput, SignalStatus, StaleClaimRecord, StatusCount, StepStatus,
    TaskExecutionPlanRecord, TaskGraphEdgeKind, TaskGraphEdgeRecord, TaskGraphMeta,
    TaskGraphNodeRecord, TaskGraphNodeRole, TaskNeighborhoodOptions, TaskNeighborhoodRecord,
    TaskOntologySignalSummary, TaskOntologySummary, TaskStepRecord, UpdateStepInput,
    UpsertLabelSemantics, accept_label_proposal, accept_label_proposal_with_options,
    add_dependency, add_dependency_with_outcome, add_task_label, add_task_label_by_id,
    add_task_labels, add_task_labels_by_id, add_task_labels_by_id_with_options,
    add_task_labels_with_options, apply_label_ontology_atom,
    apply_label_ontology_atom_with_options, archive_board, archive_task, backup_database,
    block_task, board_task_map, bootstrap_task_label, bootstrap_task_label_by_id,
    ...
    list_tasks_page, mark_execution_plan_not_required, naturalize_structured_metadata,
    normalize_legacy_priority, promote_task, propose_task_label, queue_stats, rebuild_graph_store,
    rebuild_search_index, rebuild_vector_store, reclaim_expired, reclaim_task, reclaim_task_to,
    record_label_ontology_observation, record_signal, reject_label_proposal, remove_dependency,
    remove_step, remove_task_label, remove_task_label_by_id, reopen_step, reopen_task,
