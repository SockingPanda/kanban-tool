...
import staticValidator from "virtual:kanban-contract-validator/api-checkpoint-response";
...
export type ApiCheckpointResponseContract = ContractValue<typeof ApiCheckpointResponseSchema>;
