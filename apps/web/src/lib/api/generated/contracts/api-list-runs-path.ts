...
import staticValidator from "virtual:kanban-contract-validator/api-list-runs-path";
...
export type ApiListRunsPathContract = ContractValue<typeof ApiListRunsPathSchema>;
