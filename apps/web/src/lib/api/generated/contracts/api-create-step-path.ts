...
import staticValidator from "virtual:kanban-contract-validator/api-create-step-path";
...
export type ApiCreateStepPathContract = ContractValue<typeof ApiCreateStepPathSchema>;
