...
import staticValidator from "virtual:kanban-contract-validator/api-list-dependencies-path";
...
export type ApiListDependenciesPathContract = ContractValue<typeof ApiListDependenciesPathSchema>;
