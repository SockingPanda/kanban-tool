...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-import-response";
...
export type ApiMaintenanceImportResponseContract = ContractValue<typeof ApiMaintenanceImportResponseSchema>;
