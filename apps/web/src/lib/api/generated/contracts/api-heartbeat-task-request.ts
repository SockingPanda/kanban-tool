...
import staticValidator from "virtual:kanban-contract-validator/api-heartbeat-task-request";
...
export type ApiHeartbeatTaskRequestContract = ContractValue<typeof ApiHeartbeatTaskRequestSchema>;
