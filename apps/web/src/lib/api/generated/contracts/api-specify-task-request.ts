...
import staticValidator from "virtual:kanban-contract-validator/api-specify-task-request";
...
export type ApiSpecifyTaskRequestContract = ContractValue<typeof ApiSpecifyTaskRequestSchema>;
