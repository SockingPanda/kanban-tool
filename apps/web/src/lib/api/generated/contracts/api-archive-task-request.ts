...
import staticValidator from "virtual:kanban-contract-validator/api-archive-task-request";
...
export type ApiArchiveTaskRequestContract = ContractValue<typeof ApiArchiveTaskRequestSchema>;
