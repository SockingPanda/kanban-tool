...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-import-v30-response";
...
export type ApiMaintenanceImportV30ResponseContract = ContractValue<typeof ApiMaintenanceImportV30ResponseSchema>;
