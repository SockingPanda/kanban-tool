...
import staticValidator from "virtual:kanban-contract-validator/api-add-dependency-request";
...
export type ApiAddDependencyRequestContract = ContractValue<typeof ApiAddDependencyRequestSchema>;
