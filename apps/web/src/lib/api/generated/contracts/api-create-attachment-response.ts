...
import staticValidator from "virtual:kanban-contract-validator/api-create-attachment-response";
...
export type ApiCreateAttachmentResponseContract = ContractValue<typeof ApiCreateAttachmentResponseSchema>;
