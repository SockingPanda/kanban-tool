-- Add a revert action type for append-only ontology mutation rollback history.
...
VALUES (16, '016_revert_ontology_mutation_action', '', CAST(strftime('%s','now') AS INTEGER) * 1000);
