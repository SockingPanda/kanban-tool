...
import staticValidator from "virtual:kanban-contract-validator/api-get-label-ontology-signal-path";
...
export type ApiGetLabelOntologySignalPathContract = ContractValue<typeof ApiGetLabelOntologySignalPathSchema>;
