...
import staticValidator from "virtual:kanban-contract-validator/api-search-status-response";
...
export type ApiSearchStatusResponseContract = ContractValue<typeof ApiSearchStatusResponseSchema>;
