...
import staticValidator from "virtual:kanban-contract-validator/api-list-steps-headers";
...
export type ApiListStepsHeadersContract = ContractValue<typeof ApiListStepsHeadersSchema>;
