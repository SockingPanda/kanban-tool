...
import staticValidator from "virtual:kanban-contract-validator/api-list-runs-response";
...
export type ApiListRunsResponseContract = ContractValue<typeof ApiListRunsResponseSchema>;
