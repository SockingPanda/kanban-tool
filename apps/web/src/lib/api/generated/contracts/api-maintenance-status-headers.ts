...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-status-headers";
...
export type ApiMaintenanceStatusHeadersContract = ContractValue<typeof ApiMaintenanceStatusHeadersSchema>;
