...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-import-request";
...
export type ApiMaintenanceImportRequestContract = ContractValue<typeof ApiMaintenanceImportRequestSchema>;
