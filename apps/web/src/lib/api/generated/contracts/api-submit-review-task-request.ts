...
import staticValidator from "virtual:kanban-contract-validator/api-submit-review-task-request";
...
export type ApiSubmitReviewTaskRequestContract = ContractValue<typeof ApiSubmitReviewTaskRequestSchema>;
