...
import staticValidator from "virtual:kanban-contract-validator/api-create-label-ontology-action-request";

export const ApiCreateLabelOntologyActionRequestSchema = {"$defs":{"JsonBodyField":true,"LabelOntologyActionTypeWire":{"enum":["confirm","reject","supersede","resolve_no_change","add_positive_atom","add_negative_atom","adopt_existing_atom","update_semantics","create_label_proposal","bootstrap_label","rename_label","split_label","merge_labels","revert_ontology_mutation","validate"],"type":"string"},"LabelOntologyActorWire":{"additionalProperties":false,"properties":{"agent_type":{"type":["string","null"]},"name":{"type":"string"},"type":{"type":"string"}},"required":["name","type"],"type":"object"},"LabelOntologyValidationStatusWire":{"enum":["not_required","pending","passed","failed","partial"],"type":"string"}},"$id":"urn:kanban-tool:schema:api:create-label-ontology-action-request:v1","$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"action_type":{"$ref":"#/$defs/LabelOntologyActionTypeWire"},"actor":{"$ref":"#/$defs/LabelOntologyActorWire"},"canonical_after_hash":{"type":["string","null"]},"canonical_before_hash":{"type":["string","null"]},"change":{"$ref":"#/$defs/JsonBodyField"},"idempotency_key":{"description":"作用域限定在所选看板上的 ontology lifecycle 重试 key。","type":["string","null"]},"parent_action_id":{"type":["string","null"]},"reason":{"type":"string"},"result_atom_content_hash":{"type":["string","null"]},"result_atom_id":{"type":["string","null"]},"result_label_ref":{"type":["string","null"]},"result_proposal_id":{"type":["string","null"]},"signal_ids":{"items":{"type":"string"},"type":"array"},"superseded_by_signal_id":{"type":["string","null"]},"target_label_ref":{"type":["string","null"]},"validation":{"$ref":"#/$defs/JsonBodyField"},"validation_status":{"anyOf":[{"$ref":"#/$defs/LabelOntologyValidationStatusWire"},{"type":"null"}]}},"required":["actor","action_type","signal_ids","reason"],"title":"Create label ontology action request v1","type":"object"} as const;
export type ApiCreateLabelOntologyActionRequestContract = ContractValue<typeof ApiCreateLabelOntologyActionRequestSchema>;
