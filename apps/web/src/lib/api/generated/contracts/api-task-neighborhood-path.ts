...
import staticValidator from "virtual:kanban-contract-validator/api-task-neighborhood-path";
...
export type ApiTaskNeighborhoodPathContract = ContractValue<typeof ApiTaskNeighborhoodPathSchema>;
