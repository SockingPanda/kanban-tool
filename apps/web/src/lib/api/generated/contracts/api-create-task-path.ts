...
import staticValidator from "virtual:kanban-contract-validator/api-create-task-path";
...
export type ApiCreateTaskPathContract = ContractValue<typeof ApiCreateTaskPathSchema>;
