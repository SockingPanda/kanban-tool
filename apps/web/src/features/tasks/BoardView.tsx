...
import { Text } from "../../components/ui/surface"
...
} from "../../application/tasks/task-mutation-state"
import {
  useBoardTaskMutationController,
  type BoardTaskMutationController,
} from "../../application/tasks/task-mutation-controller"
import { BOARD_PAGE_SIZE, boardPageWindow } from "../../domain/tasks/board-pagination"
...
export function BoardView({ state, messages: messageOverrides, onRetry, onSelectTask, syncStatus, id = "paper-board", className, headingLevel = 1, taskMutations }: BoardViewProps) {
