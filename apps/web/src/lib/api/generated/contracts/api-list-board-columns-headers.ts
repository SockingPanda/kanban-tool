...
import staticValidator from "virtual:kanban-contract-validator/api-list-board-columns-headers";
...
export type ApiListBoardColumnsHeadersContract = ContractValue<typeof ApiListBoardColumnsHeadersSchema>;
