...
import staticValidator from "virtual:kanban-contract-validator/api-label-atom-path";
...
export type ApiLabelAtomPathContract = ContractValue<typeof ApiLabelAtomPathSchema>;
