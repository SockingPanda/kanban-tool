...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-export-headers";
...
export type ApiMaintenanceExportHeadersContract = ContractValue<typeof ApiMaintenanceExportHeadersSchema>;
