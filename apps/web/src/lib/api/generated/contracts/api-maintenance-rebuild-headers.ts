...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-rebuild-headers";
...
export type ApiMaintenanceRebuildHeadersContract = ContractValue<typeof ApiMaintenanceRebuildHeadersSchema>;
