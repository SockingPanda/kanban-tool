...
import staticValidator from "virtual:kanban-contract-validator/api-archive-task-path";
...
export type ApiArchiveTaskPathContract = ContractValue<typeof ApiArchiveTaskPathSchema>;
