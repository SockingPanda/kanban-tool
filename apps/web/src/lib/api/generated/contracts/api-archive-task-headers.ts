...
import staticValidator from "virtual:kanban-contract-validator/api-archive-task-headers";
...
export type ApiArchiveTaskHeadersContract = ContractValue<typeof ApiArchiveTaskHeadersSchema>;
