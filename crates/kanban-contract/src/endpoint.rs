...
const ENDPOINTS: &[EndpointDescriptor] = &[
    ...
    EndpointDescriptor {
        operation_id: "api.bootstrap-task-label",
        surface: ContractSurface::Api,
        method: HttpMethod::Post,
        path: "/api/v1/tasks/:task_id/labels/bootstrap",
        migration: MigrationState::Adopted,
        exclusion: None,
        shared_components: &[],
        obligations: EndpointObligations {
            path: EndpointObligation::Contract("api.bootstrap-task-label.path"),
            query: EndpointObligation::NotApplicable,
            headers: EndpointObligation::Contract("api.bootstrap-task-label.headers"),
            body: EndpointObligation::Contract("api.bootstrap-task-label.request"),
            success: EndpointObligation::Contract("api.bootstrap-task-label.response"),
            sse: EndpointObligation::NotApplicable,
        },
    },
    EndpointDescriptor {
    ...
    EndpointDescriptor {
        operation_id: "api.search-index-rebuild",
        surface: ContractSurface::Api,
        method: HttpMethod::Post,
    ...
    EndpointDescriptor {
        operation_id: "api.search-index-sync",
        surface: ContractSurface::Api,
        method: HttpMethod::Post,
