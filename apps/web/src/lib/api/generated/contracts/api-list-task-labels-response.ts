...
import staticValidator from "virtual:kanban-contract-validator/api-list-task-labels-response";
...
export type ApiListTaskLabelsResponseContract = ContractValue<typeof ApiListTaskLabelsResponseSchema>;
