...
import staticValidator from "virtual:kanban-contract-validator/api-list-boards-response";
...
export type ApiListBoardsResponseContract = ContractValue<typeof ApiListBoardsResponseSchema>;
