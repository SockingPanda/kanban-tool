...
import staticValidator from "virtual:kanban-contract-validator/api-block-task-path";
...
export type ApiBlockTaskPathContract = ContractValue<typeof ApiBlockTaskPathSchema>;
