...
import staticValidator from "virtual:kanban-contract-validator/api-list-runs-headers";
...
export type ApiListRunsHeadersContract = ContractValue<typeof ApiListRunsHeadersSchema>;
