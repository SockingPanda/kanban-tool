...
import staticValidator from "virtual:kanban-contract-validator/api-list-dependencies-headers";
...
export type ApiListDependenciesHeadersContract = ContractValue<typeof ApiListDependenciesHeadersSchema>;
