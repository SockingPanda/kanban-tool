...
import staticValidator from "virtual:kanban-contract-validator/api-get-signal-path";
...
export type ApiGetSignalPathContract = ContractValue<typeof ApiGetSignalPathSchema>;
