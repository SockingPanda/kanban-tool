...
import staticValidator from "virtual:kanban-contract-validator/api-board-task-map-headers";
...
export type ApiBoardTaskMapHeadersContract = ContractValue<typeof ApiBoardTaskMapHeadersSchema>;
