...
import staticValidator from "virtual:kanban-contract-validator/api-complete-task-request";
...
export type ApiCompleteTaskRequestContract = ContractValue<typeof ApiCompleteTaskRequestSchema>;
