...
import staticValidator from "virtual:kanban-contract-validator/api-create-label-ontology-action-headers";
...
export type ApiCreateLabelOntologyActionHeadersContract = ContractValue<typeof ApiCreateLabelOntologyActionHeadersSchema>;
