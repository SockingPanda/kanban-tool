...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-cleanup-request";
...
export type ApiMaintenanceCleanupRequestContract = ContractValue<typeof ApiMaintenanceCleanupRequestSchema>;
