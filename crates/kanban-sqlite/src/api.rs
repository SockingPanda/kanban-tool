...
pub mod provider {
    pub use crate::service::{
        ...
        ProjectionBatch, ProjectionBatchReceipt, ProjectionDelivery, ProjectionPublishReceipt,
        ProjectionSnapshot, ProjectionSnapshotRecord, ProjectionStoreBackend,
        ProjectionStoreDescriptor, begin_projection_generation,
        ...
        reconcile_projection_generation_with, run_projection_batch_with, suggest_task_labels_with,
...
pub use crate::service::{
    ...
    MaintenanceResult, OutboxListOptions, PRIORITY_ERROR, PROJECTION_PROTOCOL_VERSION,
    ProjectionLease, ProjectionStatus, ProjectionStoreStatus, QueueStats, RunLogPathStatus,
    ...
    UpsertLabelSemantics, abort_projection_generation, accept_label_proposal,
    ...
    normalize_legacy_priority, projection_status, promote_task, propose_task_label, queue_stats,
    rebuild_graph_store, rebuild_search_index, rebuild_vector_store, reclaim_expired, reclaim_task,
    reclaim_task_to, record_label_ontology_observation, record_signal, reject_label_proposal,
