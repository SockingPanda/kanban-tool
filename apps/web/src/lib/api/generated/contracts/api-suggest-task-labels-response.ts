...
import staticValidator from "virtual:kanban-contract-validator/api-suggest-task-labels-response";
...
export type ApiSuggestTaskLabelsResponseContract = ContractValue<typeof ApiSuggestTaskLabelsResponseSchema>;
