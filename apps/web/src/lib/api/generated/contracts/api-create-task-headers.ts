...
import staticValidator from "virtual:kanban-contract-validator/api-create-task-headers";
...
export type ApiCreateTaskHeadersContract = ContractValue<typeof ApiCreateTaskHeadersSchema>;
