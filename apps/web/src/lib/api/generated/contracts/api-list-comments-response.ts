...
import staticValidator from "virtual:kanban-contract-validator/api-list-comments-response";
...
export type ApiListCommentsResponseContract = ContractValue<typeof ApiListCommentsResponseSchema>;
