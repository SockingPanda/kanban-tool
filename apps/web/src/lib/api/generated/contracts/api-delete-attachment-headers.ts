...
import staticValidator from "virtual:kanban-contract-validator/api-delete-attachment-headers";
...
export type ApiDeleteAttachmentHeadersContract = ContractValue<typeof ApiDeleteAttachmentHeadersSchema>;
