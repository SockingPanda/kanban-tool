...
import staticValidator from "virtual:kanban-contract-validator/api-remove-dependency-path";
...
export type ApiRemoveDependencyPathContract = ContractValue<typeof ApiRemoveDependencyPathSchema>;
