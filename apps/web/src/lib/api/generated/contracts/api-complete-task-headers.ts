...
import staticValidator from "virtual:kanban-contract-validator/api-complete-task-headers";
...
export type ApiCompleteTaskHeadersContract = ContractValue<typeof ApiCompleteTaskHeadersSchema>;
