...
import staticValidator from "virtual:kanban-contract-validator/api-doctor-headers";
...
export type ApiDoctorHeadersContract = ContractValue<typeof ApiDoctorHeadersSchema>;
