...
pub use crate::service::{
    ...
    MaintenanceRunReport, MaintenanceSession, MaintenanceStoreFailureKind, MaintenanceStoreResult,
    MaintenanceStoreRun, OutboxListOptions, PRIORITY_ERROR, PROJECTION_PROTOCOL_VERSION,
    ProjectionLease, ProjectionMaintenanceOwnerStatus, ProjectionRuntimeAvailability,
