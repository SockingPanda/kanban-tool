...
import staticValidator from "virtual:kanban-contract-validator/api-download-attachment-response";
...
export type ApiDownloadAttachmentResponseContract = ContractValue<typeof ApiDownloadAttachmentResponseSchema>;
