...
import staticValidator from "virtual:kanban-contract-validator/api-board-task-map-path";
...
export type ApiBoardTaskMapPathContract = ContractValue<typeof ApiBoardTaskMapPathSchema>;
