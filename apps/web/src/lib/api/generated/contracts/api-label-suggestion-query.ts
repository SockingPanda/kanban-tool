...
import staticValidator from "virtual:kanban-contract-validator/api-label-suggestion-query";
...
export type ApiLabelSuggestionQueryContract = ContractValue<typeof ApiLabelSuggestionQuerySchema>;
