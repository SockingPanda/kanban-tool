...
import staticValidator from "virtual:kanban-contract-validator/api-submit-review-task-path";
...
export type ApiSubmitReviewTaskPathContract = ContractValue<typeof ApiSubmitReviewTaskPathSchema>;
