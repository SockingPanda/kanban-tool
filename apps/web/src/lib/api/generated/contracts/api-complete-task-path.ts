...
import staticValidator from "virtual:kanban-contract-validator/api-complete-task-path";
...
export type ApiCompleteTaskPathContract = ContractValue<typeof ApiCompleteTaskPathSchema>;
