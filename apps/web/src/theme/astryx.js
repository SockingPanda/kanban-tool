...
/**
 * astryx theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { astryxTheme } from './astryx';
 *   import './astryx.css';
 */
export const astryxTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #14171a)",
    "--color-background-body": "light-dark(#f6f7f8, #0f1113)",
    "--color-background-card": "light-dark(#ffffff, #171b1f)",
    "--color-background-popover": "light-dark(#ffffff, #1b2025)",
    "--color-background-muted": "light-dark(#f0f2f4, #191d21)",
    "--color-accent": "light-dark(#0877bd, #4ba9e8)",
    "--color-accent-muted": "light-dark(#e4f3fc, #123247)",
    ...
    "--color-text-primary": "light-dark(#15181c, #f4f6f8)",
    "--color-text-secondary": "light-dark(#59616a, #a7afb8)",
    "--color-text-disabled": "light-dark(#9ca4ac, #626b75)",
    "--color-text-accent": "light-dark(#075d93, #4ba9e8)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#ffffff, #0f1113)",
    "--color-on-success": "light-dark(#ffffff, #0f1113)",
    "--color-on-error": "light-dark(#ffffff, #0f1113)",
    "--color-on-warning": "light-dark(#ffffff, #0f1113)",
    "--color-icon-accent": "light-dark(#0877bd, #4ba9e8)",
    "--color-icon-primary": "light-dark(#15181c, #f4f6f8)",
    "--color-icon-secondary": "light-dark(#59616a, #a7afb8)",
    "--color-icon-disabled": "light-dark(#9ca4ac, #626b75)",
    "--color-success": "light-dark(#147a3d, #46c878)",
    "--color-error": "light-dark(#b42332, #ef6570)",
    "--color-warning": "light-dark(#9a6500, #e9ac38)",
    "--color-success-muted": "light-dark(#e8f7ed, #163a26)",
    "--color-error-muted": "light-dark(#fdebed, #411d23)",
    "--color-warning-muted": "light-dark(#fff4d9, #3b2c12)",
    "--color-border": "light-dark(#dfe3e7, #2a2f35)",
    "--color-border-emphasized": "light-dark(#c6cdd4, #3a424a)",
