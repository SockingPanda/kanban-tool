...
export type CreateAttachmentIntent = Pick<import("../../lib/api/generated/contracts/api-create-attachment-request").ApiCreateAttachmentRequestContract, "filename">
  & Partial<Omit<import("../../lib/api/generated/contracts/api-create-attachment-request").ApiCreateAttachmentRequestContract, "actor" | "filename" | "content">>
...
export interface TaskMutationDependencies extends RpcTransportOptions {
