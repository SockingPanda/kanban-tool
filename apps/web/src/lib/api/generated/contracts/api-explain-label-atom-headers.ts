...
import staticValidator from "virtual:kanban-contract-validator/api-explain-label-atom-headers";
...
export type ApiExplainLabelAtomHeadersContract = ContractValue<typeof ApiExplainLabelAtomHeadersSchema>;
