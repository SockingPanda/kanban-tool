...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-import-v30-headers";
...
export type ApiMaintenanceImportV30HeadersContract = ContractValue<typeof ApiMaintenanceImportV30HeadersSchema>;
