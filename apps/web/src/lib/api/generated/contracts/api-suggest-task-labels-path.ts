...
import staticValidator from "virtual:kanban-contract-validator/api-suggest-task-labels-path";
...
export type ApiSuggestTaskLabelsPathContract = ContractValue<typeof ApiSuggestTaskLabelsPathSchema>;
