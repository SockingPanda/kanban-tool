...
import staticValidator from "virtual:kanban-contract-validator/api-get-task-headers";
...
export type ApiGetTaskHeadersContract = ContractValue<typeof ApiGetTaskHeadersSchema>;
