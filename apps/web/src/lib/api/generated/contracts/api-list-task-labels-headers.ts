...
import staticValidator from "virtual:kanban-contract-validator/api-list-task-labels-headers";
...
export type ApiListTaskLabelsHeadersContract = ContractValue<typeof ApiListTaskLabelsHeadersSchema>;
