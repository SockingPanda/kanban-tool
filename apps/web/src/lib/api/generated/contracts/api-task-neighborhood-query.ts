...
import staticValidator from "virtual:kanban-contract-validator/api-task-neighborhood-query";
...
export type ApiTaskNeighborhoodQueryContract = ContractValue<typeof ApiTaskNeighborhoodQuerySchema>;
