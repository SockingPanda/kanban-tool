...
import staticValidator from "virtual:kanban-contract-validator/api-review-signals-path";
...
export type ApiReviewSignalsPathContract = ContractValue<typeof ApiReviewSignalsPathSchema>;
