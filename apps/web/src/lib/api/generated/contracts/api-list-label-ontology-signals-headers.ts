...
import staticValidator from "virtual:kanban-contract-validator/api-list-label-ontology-signals-headers";
...
export type ApiListLabelOntologySignalsHeadersContract = ContractValue<typeof ApiListLabelOntologySignalsHeadersSchema>;
