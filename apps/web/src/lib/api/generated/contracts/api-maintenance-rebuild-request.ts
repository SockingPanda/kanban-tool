...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-rebuild-request";
...
export type ApiMaintenanceRebuildRequestContract = ContractValue<typeof ApiMaintenanceRebuildRequestSchema>;
