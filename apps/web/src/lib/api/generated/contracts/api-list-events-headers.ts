...
import staticValidator from "virtual:kanban-contract-validator/api-list-events-headers";
...
export type ApiListEventsHeadersContract = ContractValue<typeof ApiListEventsHeadersSchema>;
