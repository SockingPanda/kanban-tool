...
import staticValidator from "virtual:kanban-contract-validator/api-create-attachment-request";
...
export type ApiCreateAttachmentRequestContract = ContractValue<typeof ApiCreateAttachmentRequestSchema>;
