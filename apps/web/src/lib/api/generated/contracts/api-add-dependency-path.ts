...
import staticValidator from "virtual:kanban-contract-validator/api-add-dependency-path";
...
export type ApiAddDependencyPathContract = ContractValue<typeof ApiAddDependencyPathSchema>;
