...
import staticValidator from "virtual:kanban-contract-validator/api-remove-dependency-headers";
...
export type ApiRemoveDependencyHeadersContract = ContractValue<typeof ApiRemoveDependencyHeadersSchema>;
