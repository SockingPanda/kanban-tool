...
import staticValidator from "virtual:kanban-contract-validator/api-board-task-map-query";
...
export type ApiBoardTaskMapQueryContract = ContractValue<typeof ApiBoardTaskMapQuerySchema>;
