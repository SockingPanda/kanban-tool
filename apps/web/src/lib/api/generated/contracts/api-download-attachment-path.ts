...
import staticValidator from "virtual:kanban-contract-validator/api-download-attachment-path";
...
export type ApiDownloadAttachmentPathContract = ContractValue<typeof ApiDownloadAttachmentPathSchema>;
