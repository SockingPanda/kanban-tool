...
import staticValidator from "virtual:kanban-contract-validator/api-get-label-ontology-signal-headers";
...
export type ApiGetLabelOntologySignalHeadersContract = ContractValue<typeof ApiGetLabelOntologySignalHeadersSchema>;
