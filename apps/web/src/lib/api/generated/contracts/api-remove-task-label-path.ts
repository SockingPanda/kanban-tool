...
import staticValidator from "virtual:kanban-contract-validator/api-remove-task-label-path";
...
export type ApiRemoveTaskLabelPathContract = ContractValue<typeof ApiRemoveTaskLabelPathSchema>;
