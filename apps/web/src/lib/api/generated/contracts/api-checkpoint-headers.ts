...
import staticValidator from "virtual:kanban-contract-validator/api-checkpoint-headers";
...
export type ApiCheckpointHeadersContract = ContractValue<typeof ApiCheckpointHeadersSchema>;
