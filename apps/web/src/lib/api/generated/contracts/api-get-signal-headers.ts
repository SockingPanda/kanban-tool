...
import staticValidator from "virtual:kanban-contract-validator/api-get-signal-headers";
...
export type ApiGetSignalHeadersContract = ContractValue<typeof ApiGetSignalHeadersSchema>;
