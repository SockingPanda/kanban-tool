...
import staticValidator from "virtual:kanban-contract-validator/api-unblock-task-headers";
...
export type ApiUnblockTaskHeadersContract = ContractValue<typeof ApiUnblockTaskHeadersSchema>;
