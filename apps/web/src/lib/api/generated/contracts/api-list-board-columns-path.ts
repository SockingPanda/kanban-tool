...
import staticValidator from "virtual:kanban-contract-validator/api-list-board-columns-path";
...
export type ApiListBoardColumnsPathContract = ContractValue<typeof ApiListBoardColumnsPathSchema>;
