...
import staticValidator from "virtual:kanban-contract-validator/api-block-task-headers";
...
export type ApiBlockTaskHeadersContract = ContractValue<typeof ApiBlockTaskHeadersSchema>;
