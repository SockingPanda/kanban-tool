...
import staticValidator from "virtual:kanban-contract-validator/api-claim-task-path";
...
export type ApiClaimTaskPathContract = ContractValue<typeof ApiClaimTaskPathSchema>;
