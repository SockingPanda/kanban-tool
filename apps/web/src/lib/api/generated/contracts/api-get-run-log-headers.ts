...
import staticValidator from "virtual:kanban-contract-validator/api-get-run-log-headers";
...
export type ApiGetRunLogHeadersContract = ContractValue<typeof ApiGetRunLogHeadersSchema>;
