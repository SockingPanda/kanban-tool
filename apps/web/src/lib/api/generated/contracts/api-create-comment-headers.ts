...
import staticValidator from "virtual:kanban-contract-validator/api-create-comment-headers";
...
export type ApiCreateCommentHeadersContract = ContractValue<typeof ApiCreateCommentHeadersSchema>;
