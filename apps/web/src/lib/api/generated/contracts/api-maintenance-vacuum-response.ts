...
import staticValidator from "virtual:kanban-contract-validator/api-maintenance-vacuum-response";
...
export type ApiMaintenanceVacuumResponseContract = ContractValue<typeof ApiMaintenanceVacuumResponseSchema>;
