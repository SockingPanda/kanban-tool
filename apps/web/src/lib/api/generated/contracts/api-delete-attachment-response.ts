...
import staticValidator from "virtual:kanban-contract-validator/api-delete-attachment-response";
...
export type ApiDeleteAttachmentResponseContract = ContractValue<typeof ApiDeleteAttachmentResponseSchema>;
