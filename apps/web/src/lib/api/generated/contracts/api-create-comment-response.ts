...
import staticValidator from "virtual:kanban-contract-validator/api-create-comment-response";
...
export type ApiCreateCommentResponseContract = ContractValue<typeof ApiCreateCommentResponseSchema>;
