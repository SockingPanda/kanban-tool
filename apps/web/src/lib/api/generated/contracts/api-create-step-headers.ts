...
import staticValidator from "virtual:kanban-contract-validator/api-create-step-headers";
...
export type ApiCreateStepHeadersContract = ContractValue<typeof ApiCreateStepHeadersSchema>;
