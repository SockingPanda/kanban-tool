...
import staticValidator from "virtual:kanban-contract-validator/api-specify-task-path";
...
export type ApiSpecifyTaskPathContract = ContractValue<typeof ApiSpecifyTaskPathSchema>;
