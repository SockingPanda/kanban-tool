...
import staticValidator from "virtual:kanban-contract-validator/api-mark-execution-plan-not-required-headers";
...
export type ApiMarkExecutionPlanNotRequiredHeadersContract = ContractValue<typeof ApiMarkExecutionPlanNotRequiredHeadersSchema>;
