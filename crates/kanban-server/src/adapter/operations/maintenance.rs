...
impl MaintenanceQuery for TursoApplicationStore {
    ...
    async fn import_legacy_sqlite_v30(
        ...
        let options = kanban_store_turso::LegacyImportOptions {
...
fn status_record(value: kanban_store_turso::StoreMaintenanceStatus) -> MaintenanceStatusRecord {
...
fn projection_record(value: kanban_store_turso::StoreProjectionStatus) -> ProjectionStatusRecord {
