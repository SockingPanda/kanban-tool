...
import staticValidator from "virtual:kanban-contract-validator/api-create-task-request";
...
export type ApiCreateTaskRequestContract = ContractValue<typeof ApiCreateTaskRequestSchema>;
