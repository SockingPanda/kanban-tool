...
import staticValidator from "virtual:kanban-contract-validator/api-list-tasks-path";
...
export type ApiListTasksPathContract = ContractValue<typeof ApiListTasksPathSchema>;
