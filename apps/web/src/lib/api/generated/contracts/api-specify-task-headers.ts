...
import staticValidator from "virtual:kanban-contract-validator/api-specify-task-headers";
...
export type ApiSpecifyTaskHeadersContract = ContractValue<typeof ApiSpecifyTaskHeadersSchema>;
