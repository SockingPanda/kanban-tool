...
import staticValidator from "virtual:kanban-contract-validator/api-list-board-columns-response";
...
export type ApiListBoardColumnsResponseContract = ContractValue<typeof ApiListBoardColumnsResponseSchema>;
