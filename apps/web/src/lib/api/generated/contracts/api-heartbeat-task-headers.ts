...
import staticValidator from "virtual:kanban-contract-validator/api-heartbeat-task-headers";
...
export type ApiHeartbeatTaskHeadersContract = ContractValue<typeof ApiHeartbeatTaskHeadersSchema>;
