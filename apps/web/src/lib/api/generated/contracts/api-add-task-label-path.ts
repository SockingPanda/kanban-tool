...
import staticValidator from "virtual:kanban-contract-validator/api-add-task-label-path";
...
export type ApiAddTaskLabelPathContract = ContractValue<typeof ApiAddTaskLabelPathSchema>;
