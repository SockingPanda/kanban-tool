...
function RuntimeThemedShell() {
  ...
  const retainedSessionAvailable = activeBoardSlug !== null && hasActiveBoardSession(runtime, activeBoardSlug)
  const sessionRoute = boardRoute ?? (!retainedSessionAvailable || activeBoardSlug === null
    ? null
    : {
        kind: "board" as const,
