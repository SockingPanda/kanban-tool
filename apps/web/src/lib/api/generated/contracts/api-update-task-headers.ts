...
import staticValidator from "virtual:kanban-contract-validator/api-update-task-headers";
...
export type ApiUpdateTaskHeadersContract = ContractValue<typeof ApiUpdateTaskHeadersSchema>;
